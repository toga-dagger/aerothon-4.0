...
func main() {
	...
	welcome := Welcome{"Anonymous", time.Now().Format(time.Stamp)} //Variable Name, Time
	...
	//This method takes in the URL path "/" and a function that takes in a response writer, and a http request. Put Backend Here
